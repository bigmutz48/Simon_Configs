...
-- Auto-reload Neovim whenever you save this init.lua
vim.cmd [[
...
vim.cmd [[
  ...
  hi StatusLine guibg=NONE ctermbg=NONE guifg=#FFFFFF
  hi StatusLineNC guibg=NONE ctermbg=NONE guifg=#FFFFFF
]]
